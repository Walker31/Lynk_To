...
class _ChatPageState extends State<ChatPage> {
  ...
  late String loginRollNo="108121002";
                            ...
                            Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: _allMessagesContainedInTheStream[index].rollno == loginRollNo
                                        ? CrossAxisAlignment.end // Align roll number to the right if it's the current user's message
                                        : CrossAxisAlignment.start, // Align roll number to the left for other messages
                                    children: [
                                      Text(
                                          _allMessagesContainedInTheStream[index].rollno,
                                          style: TextStyle(
                                            color: _allMessagesContainedInTheStream[index].rollno == loginRollNo
                                                ? Colors.white // Color when rollno matches loginRollNo
                                                : Colors.black, // Color when rollno does not match loginRollNo
                                            fontSize: 12,
                                      ...
                                      SizedBox(
                                        ...
                                        ? TextAlign.end // Align to the right if rollno matches loginRollNo
                                        : TextAlign.start,
